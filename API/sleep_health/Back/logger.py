...
# Diretório para armazenamento dos logs
log_path = "log/"

# Verifica se o diretório para armazenar os logs existe; caso contrário, cria-o
if not os.path.exists(log_path):
   os.makedirs(log_path)

# Configuração de logging utilizando dictConfig
dictConfig({
    "version": 1,
